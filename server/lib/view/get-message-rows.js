...
module.exports = (message, sentStats = {}) => {
  ...
  if (message.state === messageStates.sent) {
    ...
    rows.push(
      ...
      [{ text: 'First message sent at' }, { text: new Date(sentStats.timeOfFirstSend).toLocaleString() }],
      [{ text: 'Last message sent at' }, { text: new Date(sentStats.timeOfLastSend).toLocaleString() }]
    )
  }
  return rows
}
